        ...
        <div className="context-info card">
          ...
          <div className="context-data forms enter-data active">
            <div className="context-header">
              <h2 className="strong">
                Using <span className="item-type-label">{name}</span>s
              </h2>
            </div>
            <div className="context-expand">
              ...
              <ul>
                <li className="enterprise">
                  <span className="strong">Submission logs</span>.
                </li>
                <li className="enterprise">
                ...
                <li className="enterprise">
                  ...
                  <span className="strong">single page application</span> of this{' '}
                  <span className="item-type-label">Resource</span>.
                </li>
              </ul>
